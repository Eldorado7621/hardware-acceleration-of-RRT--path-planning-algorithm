...
HD_PWD='/home/sam/git_workspace/thesis/hardware-acceleration-of-RRT--path-planning-algorithm/baremetal-software-validation-of-RRT-star/vivado/vivado.runs/impl_1'
cd "$HD_PWD"
